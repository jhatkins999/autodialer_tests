...
*/
//Main Part of file
// Assume the api cal has successfully returned n and list of nums
$(function()
{
    var n = 2;
    // var numbers = ['651-492-2091', '917-613-4279'];
    var numbers = ['651-492-2091'];
...
//Start calling people
    ...
    $.getJSON("./voice-token")
            .then(function(data)
            {
                device = generate_token(data);
            })
            .catch(function(err){
                console.log(err);
                log("Could not get a token from server");
            });
     document.getElementById("button-call").onclick = call(document.getElementById("phone-number").value, device);
     document.getElementById("button-hangup").onclick = hangup(device);
